...
public class CalendarView {
   ...
   // @Future
    private Date date2;
    private List<Date> multip =new ArrayList<Date>();
    private Date date3;
    private Date date4;
    private Date date5;
    private Date date6;
   ...
   // @Future
    ...
    public void onDateSelect(SelectEvent<Date> event) {
      ...
      public void onDateSelectmulti(SelectEvent<List<Date>> event) {
        FacesContext facesContext = FacesContext.getCurrentInstance();
        SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy");
    ...
    public List<Date> getMultip() {
        return multip;
    }

    public void setMultip(List<Date> multip) {
        this.multip = multip;
    }
